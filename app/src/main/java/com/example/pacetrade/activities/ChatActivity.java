...
import com.example.pacetrade.adapters.ChatAdapter;
        ...
        userQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    try {
                        Picasso.get().load(usersImage).placeholder(R.drawable.ic_userroww).into(userLogo);

                    } catch (Exception e) {

                        Picasso.get().load(R.drawable.ic_userroww).into(userLogo);
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener navListener = new BottomNavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                case R.id.nav_home:
                    Intent intent = new Intent(ChatActivity.this, TradeFeedActivity.class);
                    startActivity(intent);
                    break;
                case R.id.nav_search:
                    Intent intent2 = new Intent(ChatActivity.this, UserListActivity.class);
                    startActivity(intent2);
                    break;
                case R.id.nav_inventory:
                    Intent intent3 = new Intent(ChatActivity.this, InventoryActivity.class);
